...
sudo apt-get install -y php7.4 libapache2-mod-php7.4 php7.3-bcmath php7.3-bz2 php7.3-soap php7.4-cli php7.4-common php7.4-mbstring php7.4-gd php7.4-intl php7.4-xml php7.4-mysql php7.4-mcrypt php7.4-zip php7.4-zip openssl php-common php-curl php-json php-mbstring php-mysql php-xml php-zip
